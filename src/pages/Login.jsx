    ...
    <div className="login-container" style={{ display: "flex", minHeight: "100vh", fontFamily: "'Manrope', sans-serif" }}>
            ...
            {features.map((f, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span style={{ fontSize: "13px", color: "rgba(255,255,255,0.6)", fontWeight: 500, whiteSpace: "nowrap" }}>{f.label}</span>
                </div>
              );
            })}
          </div>
      ...
      >
        <div style={{ width: "100%", maxWidth: "380px" }}>
          ...
          <p style={{ margin: "0 0 36px", fontSize: "15px", color: "#9CA3AF" }}>Sign in to continue to your dashboard</p>
